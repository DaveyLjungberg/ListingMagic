...
export default function GeneratePage() {
  ...
  const handleRemovePhotoDesc = (photoIndex) => {
    ...
    setPhotosDesc(newPhotos);
    // photoUploaderDescRef.current?.setPhotos(newPhotos); // Removed: controlled component
  ...
  const handleLoadDescListing = (listing) => {
    ...
    // photoUploaderDescRef.current.setPhotosFromUrls(listing.photo_urls); // Removed: controlled component
  ...
  const handleClearDescData = () => {
    ...
    if (photoUploaderDescRef.current) {
      // photoUploaderDescRef.current.clearPhotos(); // Removed: controlled component
    }
    setPhotosDesc([]);
    setPhotoUrlsDesc([]);
                ...
                <div className="bg-base-100 border border-base-200 rounded-2xl p-6 space-y-6 shadow-sm">
                  ...
                  <ErrorBoundary section="Photo Uploader">
                    <PhotoUploader
                      ...
                      photos={photosDesc} // Pass photos prop
